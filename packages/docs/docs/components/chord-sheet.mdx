      ...
      measures: [
        ...
        createMeasure({
          ...
          events: [
            ...
            createLyric({ beat: 1, duration: 'whole',   text: 'tumn' }),
          ],
        }),
        createMeasure({
          number: 3,
          events: [
            ...
            createLyric({ beat: 1, duration: 'half',    text: 'leaves' }),
            createLyric({ beat: 3, duration: 'half',    text: 'are' }),
          ],
        }),
        createMeasure({
          number: 4,
          events: [
            createChord({ beat: 1, duration: 'whole',   symbol: 'D7',     root: 'D', quality: 'dominant7' }),
            createLyric({ beat: 1, duration: 'whole',   text: 'falling…' }),
          ],
        }),
      ],
    }),
...
<ChordSheet score={demoScore} measuresPerLine={4} breakAtSections />
